...
Breaking changes in lib-one
    ...
    describe('generateMaintenancePlan', () => {
        it('should create maintenance plan for major bump packages', () => {
            ...
            const result = versionService.generateMaintenancePlan(majorBumpPackages, '/test/dir');
    ...
    describe('writePlanFile', () => {
        it('should write plan to correct location', () => {
            const plan = { '@scope/lib-one': { branchName: 'release/lib-one@2.0.0', version: '2.0.0' } };
...
Breaking change
    ...
    describe('createVersionService (legacy)', () => {
        it('should create service instance', () => {
            const service = versionService.createVersionService?.(mockShellService, mockFsApi) || 
