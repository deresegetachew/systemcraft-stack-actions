...
describe('ChangesetRequirementService', () => {
  ...
  describe('fetchBranches', () => {
    ...
    it('should fetch both base and head branches', async () => {
      ...
      assert.ok(
        mockShellUtil.exec.mock.calls[0].arguments[0].includes(
          'git fetch origin main',
        ),
      );
      assert.ok(
        mockShellUtil.exec.mock.calls[1].arguments[0].includes(
  ...
  describe('getChangedFiles', () => {
    ...
    it('should call gitUtil with correct parameters', () => {
      ...
      const result = service.getChangedFiles(
        'main',
        'feature',
        'abc123',
        'def456',
      ...
      assert.strictEqual(
        mockGitUtil.getChangedFilesBetweenRefs.mock.callCount(),
        1,
      );
