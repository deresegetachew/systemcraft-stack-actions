...
describe('PackageUtil', () => {
  ...
  describe('getPackageInfo()', () => {
    it('should return null if package.json does not exist', () => {
      ...
      const result = packageUtil.getPackageInfo(
        '@scope/pkg-one',
        process.cwd(),
      );
  ...
  describe('extractMajorBumpPackagesFromChangesets()', () => {
    it('should return an empty set for empty input', () => {
      ...
      const result =
        PackageUtil.extractMajorBumpPackagesFromChangesets(emptyFiles);
    ...
    it('should extract multiple major bump packages from different files', () => {
      ...
      assert.deepStrictEqual(
        result,
        new Set(['@scope/pkg-one', '@scope/pkg-two']),
      );
    });
  ...
  describe('sanitizePackageDir()', () => {
    ...
    it('should handle scoped package names', () => {
      assert.strictEqual(
        PackageUtil.sanitizePackageDir('@scope/pkg-one'),
        'at-scope__pkg-one',
      );
    });
    ...
    it('should handle multiple slashes and at-signs', () => {
      assert.strictEqual(
        PackageUtil.sanitizePackageDir('@scope/@nested/pkg'),
        'at-scope__at-nested__pkg',
      );
    });
  });
});
